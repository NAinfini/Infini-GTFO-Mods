...
var report = new
{
    schemaVersion = 3, verification = "existing-EnemyModule-source-and-compiled-SDK-with-test-doubles",
...
Console.WriteLine($"{(failed == 0 ? "PASS" : "FAIL")} {Audit.Rows.Count - failed}/{Audit.Rows.Count} independent Enemy commit/identity/damage cases; failed {failed}. Not executed in GTFO.");
return failed == 0 ? 0 : 1;
