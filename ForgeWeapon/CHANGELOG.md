...
- `ForgeWeapon.csproj` and `ForgeWeapon.Native.csproj` both carry the package version 1.0.0, and the plugin declares versioned hard dependencies on `NAinfini.ForgeRuntime` 1.0.0 and `NAinfini.ForgeMap` 1.0.0.
