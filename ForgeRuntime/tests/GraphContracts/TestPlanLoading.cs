...
/// single-file, throw-on-reject assertions (Suite.Reject) working with a minimal signature change; it is not a
/// production compatibility layer, and lives only in test code.</summary>
