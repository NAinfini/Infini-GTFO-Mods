...
/// single-file, throw-on-reject assertions (Reject/RejectCode/Probe.Denied) working with a minimal signature change;
/// it is not a production compatibility layer, and lives only in test code.</summary>
