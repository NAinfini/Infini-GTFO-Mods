...
internal static class RuntimeDiagnostics
{
    ...
    internal static long WorldEpoch => Plugin.Runtime?.WorldEpoch ?? 0;
    internal static long? SimulationTick => Plugin.Runtime is { CurrentTick: >= 0 } runtime ? runtime.CurrentTick : null;
    ...
    internal static void Safe(Action action)
    {
        ...
        catch (Exception e)
        {
            ...
            _report?.Issue("diagnostic_error", "ForgeRuntime", e.Message, e.ToString());
    ...
    internal static void Initialize()
    {
        ...
        _report.SetMetadata("forgeVersion", Plugin.PluginVersion);
    ...
    internal static void Begin()
    {
        ...
        _report.SetMetadata("mode", Plugin.ConfiguredMode.ToString());
    ...
    internal static void Export(string outcome)
    {
        ...
        {
            _report.Issue("report_queue_full", "ForgeRuntime", "Report was not queued; previous files do not include this requested snapshot.");
