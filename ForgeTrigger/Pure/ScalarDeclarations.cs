...
internal static class ScalarDeclarations
{
    ...
    {
        PureModule.Row("forge.modifier.value.constant", "modifier", "类型化常量", "给出一个固定的数。",
        ...
        PureModule.Row("forge.modifier.value.subtract", "modifier", "减法", "相减。",
        ...
        PureModule.Row("forge.modifier.value.divide", "modifier", "除法并拒绝零分母", "相除，除零时按你选的规则处理。",
            PureModule.Inputs(PureModule.Number("a"), PureModule.Number("b")), PureModule.Outputs(PureModule.Number("value")),
        ...
        PureModule.Row("forge.modifier.value.clamp", "modifier", "范围截断", "把数值卡在上下限之间。",
        ...
        PureModule.Row("forge.modifier.value.absolute", "modifier", "绝对值", "取绝对值。",
        ...
        PureModule.Row("forge.modifier.value.round", "modifier", "明确舍入规则", "按你选的规则取整。",
        ...
        PureModule.Row("forge.modifier.value.random_range", "modifier", "有种子的随机范围", "在一个区间里随机取数，同种子同结果。",
